...
Label(register, text ="Do you mind living near a train track? not so much(1-5)a lot").grid(row = 0, column = 0, sticky=W, pady = 3)
Label(register, text ="Do you mind living near a main road? not so much(1-5)a lot").grid(row = 1, column = 0, sticky=W, pady = 3)
Label(register, text ="You want to live surrounded by kids? (TRUE or FALSE)").grid(row = 2, column = 0, sticky=W, pady = 3)
Label(register, text ="How important is this for you? not important(1-5)very important").grid(row = 3, column = 0, sticky=W, pady = 3)
Label(register, text ="You want to live surrounded by elderly people? (TRUE or FALSE)").grid(row = 4, column = 0, sticky=W, pady = 3)
Label(register, text ="How important is this for you? not important(1-5)very important").grid(row = 5, column = 0, sticky=W, pady = 3)
Label(register, text ="You want to live in a rural area? (TRUE or FALSE)").grid(row = 6, column = 0, sticky=W, pady = 3)
Label(register, text ="How important is this for you? not important(1-5)very important").grid(row = 7, column = 0, sticky=W, pady = 3)

Label(register, text ="How much do you mind noise from trains and cars? don't mind(1-5)hate it").grid(row = 9, column = 0, sticky=W, pady = 3)
Label(register, text ="Do you care about the composition of the neighbourhood? no not at all(1-5)very much").grid(row = 10, column = 0, sticky=W, pady = 3)
Label(register, text ="How important are closeby facilities for you? don't care about it(1-5)need them").grid(row = 11, column = 0, sticky=W, pady = 3)
Label(register, text ="How important is a green living environment for you? hate nature(1-5)very important").grid(row = 12, column = 0, sticky=W, pady = 3)
Label(register, text ="How important is living near water for you? hate water(1-5)love water").grid(row = 13, column = 0, sticky=W, pady = 3)
Label(register, text ="How important is living near public transport? not at all(1-5)a lot").grid(row = 14, column = 0, sticky=W, pady = 3)
